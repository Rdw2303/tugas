...
<div class="page-heading">
    ...
    <a href="/tambahDtl" class="btn btn-info mb-3">Tambah Data</a>
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td>{{$baris->total}}</td>
                                    <td>
                                        <a href="/editDtl/{{$baris->id}}" class="btn btn-warning">Edit</a>
                                        <a href="/hapusDtl/{{$baris->id}}" class="btn btn-danger">Hapus</a>
                                    </td>
                                   </tr>
                                   @endforeach
                                </tbody>
